...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Added unique breweries count query into Promise.all execution
        ...
        res.status(200).json({
            ...
            totalBreweries: parseInt(breweryCountResult[0].total_breweries), // <--- Sent to frontend script automatically
            page,
            limit,
